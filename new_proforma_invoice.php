...
<head>
    ...
    <title>New Proforma Invoie</title>
...
<body>
    ...
    <h3 class="bg-dark text-center" style="color:#fff;padding:8px;font-size:32px;">NEW PROFORMA INVOICE</h3>
    ...
    <form action="" method="POST" class="form-action">
        <div class="row" style="margin:1px;">
            ...
            <div class="col-sm-4">
                ...
                <input type="date" id="valid_until" name="valid_until" class="form-control mb-3">
