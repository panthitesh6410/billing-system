...
<body>
    ...
    <h3 class="bg-dark text-center" style="color:#fff;padding:8px;font-size:32px;">NEW CHALLAN</h3>
    ...
    <form action="" method="POST" class="form-action">
        <div class="row" style="margin:1px;">
            ...
            <div class="col-sm-4">
                ...
                <label for="project">Project</label><input type="text" id="project" name="project" class="form-control">
            </div>
            <div class="col-sm-4">
                <label for="date">Date :</label>
                <input type="date" id="date" name="date" class="form-control mb-3">
                <label for="shipping_date"> Shipping Date :</label>
                <input type="date" id="shipping_date" name="shipping_date" class="form-control mb-3">
                <input type="checkbox" name="hide" id="hide" class="mt-3" style="height:20px;width:50px;"><label for="hide">Hide Shipping Date on Document</label>
            </div>
        </div>
        <hr/>
